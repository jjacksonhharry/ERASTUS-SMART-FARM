...
const Products = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 150,
      image: './1 week.jpg',
      description: 'Healthy, vaccinated one week old chicks ready for raising',
      rating: 5,
      features: ['Vaccinated', 'Health guaranteed', 'Various breeds available'],
      category: 'Live Birds'
    },
    ...
    },
    {
      ...
      description: 'Premium free-range broilers, processed fresh daily (per kg)',
      rating: 5,
    ...
    },
    {
      ...
      description: 'Traditional indigenous chickens, naturally raised and flavorful (per kg)',
      rating: 5,
